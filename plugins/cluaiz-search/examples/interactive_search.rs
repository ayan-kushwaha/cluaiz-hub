...
fn main() {
    println!("==================================================");
    println!("🔍 cluaiz Search Plugin - Interactive Test 🔍");
    println!("==================================================");
    ...
    loop {
        ...
        let manifest_str = std::fs::read_to_string("manifest-plugin.yaml").unwrap_or_default();
        ...
        let ext_payload = cluaiz_search::CxpPayload {
