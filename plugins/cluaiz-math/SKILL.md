...
trigger: use plugin::cluaiz-math
---
...
```cel
use plugin::cluaiz-math -> execute(action: "mean", values: [1.2, 4.5, 3.8])
```
...
## Constraints
- This plugin runs in a sandboxed WASM environment with a strict RAM allocation limit and an instruction budget. Ensure calculation size fits within limits.
